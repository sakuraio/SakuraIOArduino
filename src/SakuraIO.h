...
public:
  ...
  uint8_t immediatelySendRaw(uint8_t ch, uint8_t type, uint8_t length, uint8_t *data, uint64_t offset);
  uint8_t immediatelySend(uint8_t ch, int32_t value, uint64_t offset);
  uint8_t immediatelySend(uint8_t ch, uint32_t value, uint64_t offset);
  uint8_t immediatelySend(uint8_t ch, int64_t value, uint64_t offset);
  uint8_t immediatelySend(uint8_t ch, uint64_t value, uint64_t offset);
  uint8_t immediatelySend(uint8_t ch, float value, uint64_t offset);
  uint8_t immediatelySend(uint8_t ch, double value, uint64_t offset);
  uint8_t immediatelySend(uint8_t ch, uint8_t value[8], uint64_t offset);
  uint8_t immediatelySend(uint8_t ch, int32_t value);
  uint8_t immediatelySend(uint8_t ch, uint32_t value);
  uint8_t immediatelySend(uint8_t ch, int64_t value);
  uint8_t immediatelySend(uint8_t ch, uint64_t value);
  uint8_t immediatelySend(uint8_t ch, float value);
  uint8_t immediatelySend(uint8_t ch, double value);
  uint8_t immediatelySend(uint8_t ch, uint8_t value[8]);
